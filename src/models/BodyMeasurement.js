...
const measurementsSchema = new mongoose.Schema(
  {
    ...
    neck: { type: Number, default: 0, min: 0, max: 150 },
    shoulders: { type: Number, default: 0, min: 0, max: 300 },
    rightArm: { type: Number, default: 0, min: 0, max: 150 },
    leftArm: { type: Number, default: 0, min: 0, max: 150 },
    rightForearm: { type: Number, default: 0, min: 0, max: 120 },
    leftForearm: { type: Number, default: 0, min: 0, max: 120 },
